...
const ROLE_EXECUTION_DIMENSIONS = new Set([
  'story_function',
  'risk_attitude',
  'trust_pattern',
  'responsibility',
...
const ROLE_EXECUTION_DIRECTIONS = new Set([
  'hold',
  'more_open',
  'more_closed',
  'more_active',
...
const ROLE_EXECUTION_SCOPES = new Set([
  'temporary',
  'stage',
  'core_candidate'
]);

const ROLE_EXECUTION_CONFIDENCE = new Set([
  'low',
  'medium',
  'high'
]);

const ROLE_DIMENSION_LABELS = {
  story_function: '剧情职责',
  risk_attitude: '风险态度',
  trust_pattern: '信任方式',
  responsibility: '责任承担',
